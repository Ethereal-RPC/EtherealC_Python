...
from EtherealC.Net.Abstract.NetConfig import NetConfig
    ...
    if name is not None:
        ...
        if net is not None:
            for request in net.requests:
                EtherealC.Request.RequestCore.UnRegister(net_name=net, service_name=request.service_name)
            for service in net.services:
                EtherealC.Service.ServiceCore.UnRegister(net_name=net, service_name=service.service_name)
            del nets[name]
    return True
